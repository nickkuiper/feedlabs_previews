...
feeds = {
    ...
    'Borzo Hyperlocal': {'url': 'https://storage.googleapis.com/feeds_management/borzo_hyperlocal/feeds/production/borzo_hyperlocal_feed.csv', 'fields' : ['id', 'title'], 'image_field' : ['image[0].url'], 'items' : 3, 'tid' : base_telegram_id},
